    ...
    <tr>
        <td>
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center">
                <tr>  <td><img src="<?php echo e(url('images/emailtop.png')); ?>"></td> </tr>
            </table>

            <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" height="100" bgcolor="#FFFFFF">
                <tr>
                    <td style="font-size:30px; color:#ef5023; font-family:Arial Black; text-align:center; font-weight:bold; line-height:20px;"><?php echo e($subject); ?></td>
                </tr>
            </table>
            ...
            <table width="95%" cellpadding="0" cellspacing="0" border="0" align="center" height="15">
                <tr>
                    <td style=" font-size:14px; font-family:Arial; text-align:left; line-height:20px;">Hello <strong>
                            <?php echo e($name); ?>,</strong><br/><br/></td>
                </tr>
            </table>
            ...
            <table width="95%" cellpadding="0" cellspacing="0" border="0" align="center" height="50">
                ...
                <tr>
                    ...
                    <td style="width:200px;">
                        <a target="_blank" href="<?php echo e($helper->getFacebookUrl()); ?>"><img
                                    src="<?php echo e(url('images/facebook-icon.png')); ?>" width="29" height="28"></a>
                        <a target="_blank" href="<?php echo e($helper->getTwitterUrl()); ?>"><img
                                    src="<?php echo e(url('images/twitter-icon.png')); ?>" width="29" height="28"></a>
            ...
            <table  width="100%" cellpadding="0" cellspacing="0" border="0" align="center"                                                      >
                <tr>
                    <td><img src="<?php echo e(url('images/emailbottom.png')); ?>" width="600" height="auto">
                    </td>
                </tr>
            </table>
        </td>
