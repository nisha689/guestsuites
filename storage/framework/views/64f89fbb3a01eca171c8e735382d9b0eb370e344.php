<?php $__env->startSection('title', 'Customers | '.trans('admin.front_title')); ?>
<?php $__env->startSection('content'); ?>
            ...
            <div class="page-wrap bx-shadow mt-5 mb-5">
                <div class="row user-dt-wrap">
                    <div class="col-lg-12 col-md-12 pb-5">
                        <h1 class="admin_bigheading mb-5 inlinebtn">Customers(<?php echo e($totalRecordCount); ?>)</h1>
                        ...
                        <?php echo Form::open(['method' => 'GET','name'=>'admin-teacher-search', 'id' =>'admin_teacher_search_form', 'class'=>'top-search-options form-row pb-4','route' => ['admin.customers']]); ?>
    ...
    <?php echo $__env->make('admin.customer.contact_model', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('admin.customer.add_edit_model', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('javascript'); ?>
    <script>
        ...
        window.addEditTeacherUrl = "<?php echo e(URL::to('admin/customer/save_ajax')); ?>";
