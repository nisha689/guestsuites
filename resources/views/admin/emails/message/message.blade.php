    ...
    <tr>
        <td>
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center">
                <tr>  <td><img src="{{ url('images/emailtop.png') }}"></td> </tr>
            </table>

            <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" height="100" bgcolor="#FFFFFF">
                <tr>
                    <td style="font-size:30px; color:#ef5023; font-family:Arial Black; text-align:center; font-weight:bold; line-height:30px;">{{ $subject }}</td>
                </tr>
            </table>
            ...
            <table width="95%" cellpadding="0" cellspacing="0" border="0" align="center" height="50">
                <tr>
                    <td style=" font-size:14px; font-family:Arial; text-align:left; line-height:20px;">
                        <strong>Below is a message from {{ $senderName }} sent via the Web:</strong>
                        @if(!empty($message))
                        <br>
                        <br>
                        {!! nl2br($message) !!}
