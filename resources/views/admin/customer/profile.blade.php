...
@section('title', 'Customer Profile | '.trans('admin.front_title'))
@section('content')
            ...
            <div class="page-wrap bx-shadow my-5 px-sm-5 ">
                <div class="row user-dt-wrap">
                    <div class="col-lg-12 col-md-12 pb-5 school_details">
                        <h1 class="big-heading mb-5">Customer ({{ $business->name }})</h1>
                        <div class="row">
                            ...
                            'route' => ['admin.customer.ban_reactive'])) !!}
                                    ...
                                    {!! Form::open(array('method' => 'DELETE',
                                                        ...
                                                        'route' => ['admin.customer.delete'], 'id'=>'removeteacher')) !!}
                            ...
                            <div class="col-lg-6 col-md-6 pb-5 px-md-5 label_blue pb0">
                                ...
                                <div class="row after_bottom_border">
                                    <div class="col-lg-12 col-md-12">
                                        {!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'admin-change-password-form', 'id' =>'admin_change_password_form', 'class'=>'login-form','data-parsley-validate','route' => ['admin.customer.change_password']]) !!}
                            ...
                            <div class="col-lg-12 pb-0 px-md-5 mt-5 label_blue">
                                ...
                                {!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'admin-edit-profile-form', 'id' =>'admin_edit_profile_form', 'class'=>'login-form','data-parsley-validate','route' => ['admin.customer.profile.save']]) !!}
                                ...
                                <div class="form-edit-profile">
                                  ...
                                  {!! Form::select('business_id', $businessDropDownForAdd, $business->business_id, ['class' => 'form-control mb-4', 'required' => '']) !!}
                              </div>
...
@section('javascript')
    <script>
        function teacherDelete() {
            var dynamicDialog = $('<div id="conformBox">' + 'Are you sure you want to delete this customer?</div>');
        ...
        function teacherDeleteConfirm() {
            var dynamicDialog2 = $('<div id="conformBox">' + 'Deleting customer is permanent and cannot be undone?</div>');
