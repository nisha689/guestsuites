...
@section('title', 'Customers | '.trans('admin.front_title'))
@section('content')
            ...
            <div class="page-wrap bx-shadow mt-5 mb-5">
                <div class="row user-dt-wrap">
                    <div class="col-lg-12 col-md-12 pb-5">
                        <h1 class="admin_bigheading mb-5 inlinebtn">Customers({{ $totalRecordCount }})</h1>
                        <a href="javascript:void(0)" onclick="openTeacherModal('#teacher_model')"
                           class="btn light_blue float-right newbtn">New Customer</a>
                        <div class="clear-both"></div>
                        {!! Form::open(['method' => 'GET','name'=>'admin-teacher-search', 'id' =>'admin_teacher_search_form', 'class'=>'top-search-options form-row pb-4','route' => ['admin.customers']]) !!}
                        ...
                        <div class="col-md-4 col-lg-3">
                            {!! Form::select('business_id', $businessDropDown, $businessId, ['class' => 'form-control mb-3']) !!}
                        </div>
                                ...
                                @if(!empty($businesses) && count($businesses) > 0)
                                    @foreach($businesses as $businessKey => $business)
                                        <tr>
                                            ...
                                            <td>
                                                <b>{{ $business->getDateById($business->business_id)->company_name }}</b>
                                            </td>
                                            ...
                                            <td class="bigfonts"><b>{{ $business->gender_type  }}</b></td>
                                            ...
                                            <td class="action_div">
                                                <div class="action-warp">
                                                    ...
                                                    <div class="right-action">
                                                        {!! Form::open(array(
                                                                'method' => 'DELETE',
                                                                 'onsubmit' => "return confirm('".trans("admin.qa_are_you_sure_delete")." customer?');",
    ...
    @include('admin.customer.contact_model')
    @include('admin.customer.add_edit_model')
@endsection
@section('javascript')
    <script>
        ...
        window.addEditTeacherUrl = "{{ URL::to('admin/customer/save_ajax') }}";
