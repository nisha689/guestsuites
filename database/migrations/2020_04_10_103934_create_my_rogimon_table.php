...
class CreateMyRogimonTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gs_my_rogimon', function (Blueprint $table) {
            $table->increments('my_rogimon_id');
    ...
    {
        Schema::dropIfExists('gs_my_rogimon');
    }
}
