...
class CreateCustomerHistoryTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('gs_customer_history', function (Blueprint $table) {
            ...
            $table->foreign('history_id')->references('history_id')->on('gs_history')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('gs_customer_history');
    }
}
