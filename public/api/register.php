...
if($check_token[0]=='1') {
	...
	if($first_name == '' || $last_name == '' || $email == '' || $role_id=='' || $business_type=='' || $phone = ''){
	...
	elseif($password!=$confirm_password){
		...
		$user_data['status'] 				=	'1';		
		$user_data['business_service_id'] 	=	$business_type;		
