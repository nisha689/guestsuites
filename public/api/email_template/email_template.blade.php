    ...
    <tr>
        <td>
            ...
            <table width="95%" cellpadding="0" cellspacing="0" border="0" align="center" height="50">
                ...
                <tr>
                    ...
                    <td style="width:200px;">
                        <a target="_blank" href="[facebook_url]"><img
                                    src="[facebook_image]" width="29" height="28"></a>
                        <a target="_blank" href="[twitter_url]"><img
                                    src="[twitter_image]" width="29" height="28"></a>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
                <tr>
                    <td><img src="[bottom_image]" width="600" height="auto">
                    </td>
                </tr>
            </table>
        </td>
